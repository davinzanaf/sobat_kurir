...
<section class="bg-slate-50 px-5 py-10 lg:px-8">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="mb-5 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <form method="GET" action="{{ route('admin.pesanan.index') }}" class="flex flex-col gap-3 md:flex-row">
                <div class="flex-1">
                    ...
                    <input
                        ...
                        name="q"
                        value="{{ $q ?? request('q') }}"
                        placeholder="Cari kode resi, nama penerima, nama pengirim, atau no HP..."
