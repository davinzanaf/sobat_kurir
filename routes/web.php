...
Route::get('/daftar-kurir', [AuthController::class, 'showDaftarKurir'])->name('kurir.daftar');
Route::post('/daftar-kurir', [AuthController::class, 'daftarKurir'])->name('kurir.daftar.process');

Route::post('/logout', [AuthController::class, 'logout'])->name('logout');

Route::get('/customer', [HomeController::class, 'customer'])->name('customer.public');
